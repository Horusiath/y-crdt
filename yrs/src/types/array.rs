...
use crate::types::{
    event_change_set, AsPrelim, Change, ChangeSet, DefaultPrelim, In, Node, NodePtr, Out, Path,
    RootRef, SharedRef, ToJson, TypeRef,
};
use crate::{Any, DeepObservable, Doc, IndexedSequence, Observable, Transaction, ID};
...
impl Prelim for ArrayPrelim {
    ...
    fn into_content(self, _txn: &mut TransactionMut) -> (ItemContent, Option<Self>) {
        let inner = Node::new(TypeRef::Array);
